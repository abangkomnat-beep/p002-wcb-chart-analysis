...
class ทะเบียนคำค้นต่อสินทรัพย์(unittest.TestCase):
    ...
    def test_ทะเบียนตรงกับสเปกของหัวหน้าทีละตัวอักษร(self):
        ...
        spec = {
            ...
            "usdjpy": ("USD/JPY", "แนวโน้มดอลลาร์ต่อเยน"),          # Forex §1 (เพิ่ม 08-21)
            "audusd": ("AUD/USD", "แนวโน้มดอลลาร์ออสเตรเลียต่อดอลลาร์"),
            "usdcad": ("USD/CAD", "แนวโน้มดอลลาร์สหรัฐต่อดอลลาร์แคนาดา"),
