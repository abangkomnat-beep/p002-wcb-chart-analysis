...
- **ไฟล์แผนอยู่ฝั่ง internal ทั้งหมด** — แต่ **ตัวเลขจุดเข้า จุดตัดขาดทุน เป้าหมาย และอัตราส่วน เล่าในบทความสไตล์ ② ได้แล้ว** (ผู้ใช้ปลดมติข้อ 14ก เมื่อ 2026-08-04) · เกณฑ์ว่าแผนไหนพูดได้อยู่ที่ `writers.plan_for_public()` ที่เดียว และภาษาต้องเป็นเงื่อนไขระดับวันเท่านั้น — ดู Contract ข้อ 3ก
...
- **ค่าเกณฑ์ยังไม่ล็อก** — `risk_auditor.DEFAULT_THRESHOLDS` (RR 1.5 · SL ≥ 1.0 ATR · entry ≤ 2.0 ATR) เป็นค่าตั้งต้นที่ยังไม่ได้วัดกับข้อมูลจริงทั้ง 4 สินทรัพย์
