...
def _structure_plan(data: dict, plan: dict) -> list[str]:
    ...
    #
    # ตั้งแต่ 2026-08-05 (ทาง ค) `trade_plan.select_targets()` ไม่ปล่อยเป้าที่อัตราส่วน
    # ต่ำกว่าเกณฑ์ออกมาแล้ว บรรทัดนี้จึงไม่ทำงานตราบใดที่เกณฑ์ที่ผู้ใช้ล็อก ≥ 1.0
    # **คงไว้โดยตั้งใจ** เป็นตาข่ายกันกรณีที่ค่าเกณฑ์ถูกตั้งต่ำกว่า 1 ในอนาคต —
    # ราคาที่จ่ายคือสี่บรรทัด ส่วนที่กันได้คือบทความที่โฆษณาแผนซึ่งเสี่ยงมากกว่าได้
