...
# ค่าเกณฑ์ตั้งต้น — **วัดแล้ว 2026-08-05 และพบว่าใช้ร่วมกันไม่ได้ · ยังไม่ล็อก**
#
# วัดย้อนหลัง 484 วัน (121 วัน × 4 สินทรัพย์ ด้วยข้อมูล MT5 จริง) ได้ผลดังนี้:
#   · แผนออก 221 วัน (46%) แต่ผ่านด่านนี้ **0 วัน**
#   · minimum_stop_atr = 1.0 ยิง 218/221 ครั้ง (99%) — ระยะจริง 0.35–0.40 ATR ทั้งสี่สินทรัพย์
#   · minimum_rr = 1.5 ยิง 174/221 ครั้ง (79%) — อัตราส่วนจริงที่เป้าแรก ~1.0
#   · maximum_entry_atr = 2.0 ยิง 0/221 ครั้ง — ค่าจริง 0.18–0.23 ATR (เกณฑ์ไม่ทำงานเลย)
#
# ⚠️ สองข้อแรก **สนองพร้อมกันไม่ได้** เพราะเป้าหมายกับจุดตัดขาดทุนดึงจากตารางระดับ
# ชุดเดียวกัน ระยะสองฝั่งจึงล็อกกัน — ถ่าง SL ให้ผ่านข้อ 2 แล้วอัตราส่วนเหลือ 0.35
# ⇒ ไม่มีวันไหนจาก 484 วันผ่าน RR ≥ 1.5 เลย · **นี่คือข้อจำกัดเชิงโครงสร้าง ไม่ใช่ค่าที่ตั้งผิด**
#
# **ห้ามแก้ค่าในนี้เพื่อให้แผนผ่าน** — ผู้ใช้เลือกทาง ค เมื่อ 2026-08-05 คือแก้วิธีเลือก
# เป้าหมายในตัวสร้างแผน แล้วค่อยวัดใหม่และล็อกค่าพร้อมกันรอบเดียว
