...
def _excerpt_clauses(story: dict) -> list[str]:
    ...
    clauses += ["อ่านโครงสร้างกราฟรายวันพร้อมจุดเข้าและจุดที่ต้องล้มเลิกความคิดเดิมทั้งสองฝั่ง",
...
def render_article(story: dict) -> str:
    ...
    if entries:
        entry_lines += [
            ...
            "พร้อมจุดที่ต้องล้มเลิกความคิดเดิมชัดเจนทุกจุดครับ",
            "",
        ]
        entry_groups = []
        for entry in entries:
            ...
            entry_groups.append((
                ...
                [f"โซนนี้ถูกใช้เป็นแนวอ้างอิงมาแล้ว {entry['touches']} ครั้ง — "
                 ...
                 f"จุดที่ต้องล้มเลิกความคิดเดิม: ราคาปิดวันต่ำกว่า "
    ...
    if up:
        ...
        bullish_items.append(
            f"**จุดที่ต้องล้มเลิกความคิดเดิม:** เมื่อ{up['invalidation']} "
        ...
        lines += wcb_writers.listing("", [
            ...
            f"**ขั้นที่ 4 —** จุดที่ต้องล้มเลิกความคิดเดิม: ราคาปิดวันกลับต่ำกว่า "
    ...
    if down_scenario:
        ...
        bearish_items.append(f"**จุดที่ต้องล้มเลิกความคิดเดิม:** เมื่อ{down_scenario['invalidation']}")
    ...
    if upper_gate or lower_gate:
        ...
        summary_items.append(
            ...
            "ไม่ไล่ราคากลางกรอบ และวางจุดที่ต้องล้มเลิกความคิดเดิมก่อนเข้าทุกครั้ง")
